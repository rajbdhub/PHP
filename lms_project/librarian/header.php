...
$page = end($p);
 ...
 $result = mysqli_query($conn, "SELECT * FROM `libraian` WHERE `email` = '$email'");
 $query = mysqli_fetch_assoc($result);

$username = $_SESSION['libraian_username'];

$result2 = mysqli_query($conn, "SELECT * FROM `libraian` WHERE `username` = '$username'");
            ...
            <div class="header-section" id="user-headerbox">
                <div class="user-header-wrap">
                    <div class="user-photo">
                        <img alt="profile photo" src="../images/libraian/2.png" />
                    </div>
                    <div class="user-info">
                        <span class="user-name"><?= $query['firstname'].' '.$query['lastname'] ?>
                        </span>
                ...
                <div class="nano-content">
                    <nav>
                        <ul class="nav nav-left-lines" id="main-nav">
                            ...
                            <li class="has-child-item close-item <?= $page == 'manage-books.php' ? 'open-item' : '' ?> <?= $page == 'add-books.php' ? 'open-item' : '' ?>">
                                <a><i class="fa fa-book" aria-hidden="true"></i><span>Books</span></a>
                                <ul class="nav child-nav level-1" style="">
                                    <li class="<?= $page == 'add-books.php' ? 'active-item' : '' ?>"><a href="add-books.php"><i class="fa fa-plus-circle"></i>Add Book</a></li>
                                    <li class="<?= $page == 'manage-books.php' ? 'active-item' : '' ?>"><a href="manage-books.php"><i class="fa fa-pencil-square" aria-hidden="true"></i>
                                            Manage Book</a></li>
                            ...
                            <li class="<?= $page == 'return-book.php' ? 'active-item' : '' ?>"><a href="return-book.php"><i class="fa fa-book" aria-hidden="true"></i>
                                    Return Book</a></li>
                        </ul>
                    </nav>
                </div>
